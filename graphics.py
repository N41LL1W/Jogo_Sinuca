...
class Canvas:
    def __init__(self):
        ...
        self.background = pygame.Surface(config.surface.get_size())
...
def create_buttons(text, text_font, text_color_normal, text_color_on_hover, text_font):
    ...
    screen_botton_middles = np.stack((np.repeat([screen_mid], len(buttons)),
